...
def home_page():
    ...
    """, unsafe_allow_html=True)
    st.markdown("""<style>.stVerticalBlock.st-key-doc11 {background-color: #6c7b7b; color: white; padding: 20px; border-radius: 10px; transition: all 0.3s ease-in-out; min-height: 350px; display: flex; flex-direction: column;} .stVerticalBlock.st-key-doc11:hover {background-color: rgba(245,245,245,0.8); color: black; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2); transform: translateY(-2px);} </style>""", unsafe_allow_html=True)
    st.markdown("""<style>.stVerticalBlock.st-key-doc12 {background-color: #6c7b7b; color: white; padding: 20px; border-radius: 10px; transition: all 0.3s ease-in-out; min-height: 350px; display: flex; flex-direction: column;} .stVerticalBlock.st-key-doc12:hover {background-color: rgba(245,245,245,0.8); color: black; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2); transform: translateY(-2px);} </style>""", unsafe_allow_html=True)
